    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-orange-50 to-orange-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 mb-6 border border-orange-100">
          ...
          {/* Server List Toggle Button */}
          <button
            onClick={() => setShowServerList(!showServerList)}
            className="w-full mt-4 py-3 px-6 rounded-xl font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 transition-all duration-200"
          >
            {showServerList ? 'Hide' : 'Show'} Server List
          </button>
        </div>
